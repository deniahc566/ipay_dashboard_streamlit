...
def render_cyber_risk_page():
    ...
    st.markdown(
        ...
        'BÁO CÁO CHI TIẾT SẢN PHẨM CYBER RISK</h1>',
        unsafe_allow_html=True,
    )
    ...
    with chart_cols[0]:
        ...
        st.markdown(
            ...
            'background:#C47A00;margin-right:4px;vertical-align:middle;"></span>Có hiệu lực</span>'
            '<span><span style="display:inline-block;width:8px;height:8px;border-radius:50%;'
            'background:#F0C060;margin-right:4px;vertical-align:middle;"></span>Tạm ngưng</span>'
            '</div>',
            unsafe_allow_html=True,
        )
        _pie = (
        ...
        st.markdown(
            ...
            f'</div>'
            f'<div style="text-align:center;font-size:0.57rem;color:#C47A00;margin-top:3px;">'
        ...
        if not _melted.empty:
            ...
            _bar_labels = (
                ...
                .encode(
                    ...
                    color=alt.Color(
                        "Loại:N",
                        scale=alt.Scale(domain=_bar_order, range=["#B85C00", "#E8A055"]),
                    ),
            ...
            st.markdown(
                ...
                'background:#B85C00;margin-right:4px;vertical-align:middle;"></span>Thực thu</span>'
                '<span><span style="display:inline-block;width:8px;height:8px;border-radius:2px;'
                'background:#E8A055;margin-right:4px;vertical-align:middle;"></span>Dự kiến</span>'
                '</div>',
                unsafe_allow_html=True,
            )
    ...
    with tbl_cols[1]:
        ...
        tbl_year = st.selectbox(
            "Năm", options=tbl_year_opts, index=0, key="cyber_tbl_year"
        )
    ...
    if day_df.empty:
        ...
        for i, r in day_df.iterrows():
            ...
            html_rows.append(
                ...
                f'<td style="padding:4px 8px;text-align:right;color:#B85C00;">{tien_dk:,.0f}</td>'
                f'<td style="padding:4px 8px;text-align:right;">'
        ...
        total_row = (
            f'<tr style="background:#B85C00;color:white;font-weight:600;">'
        ...
        st.markdown(
            ...
            f'<thead><tr style="background:#B85C00;color:white;">{header_html}</tr></thead>'
